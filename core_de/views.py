...
def home(request):
    return render(request, 'core_de/home.html')
...
def contact(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('/de/kontakt/?submitted=True') 
        else:
            print(form.errors)  # Print form errors if the form is not valid
            return render(request, 'core_de/contact.html', {'form': form})
    else:
...
def services(request):
    return render(request, 'core_de/services.html')

def about(request):
    return render(request, 'core_de/about.html')

def gallery(request):
    return render(request, 'core_de/gallery.html')

def template(request):
    return render(request, 'core_de/template.html')
